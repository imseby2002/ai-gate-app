...
const COPY: Record<Locale, Copy> = {
  'zh-TW': {
    ...
    cards: {
      ...
      core: ['5 房源（+$4/房源）', '1 位協作者', '動態定價規則', 'Email 同步（OTA信件轉單）'],
      pro: ['5 房源（+$3/房源）', '2 位協作者', '即時同步 60+ 平台（秒級防超賣）', '與 CS 串接（訂單密碼連動）', '每月 1 次免費協助設定'],
      enterprise: ['15 房源（+$2/房源）', '無上限協作者', '動態定價客製規則', '每月 2 次免費協助設定'],
    },
    rows: [
  ...
  en: {
    ...
    cards: {
      ...
      core: ['5 properties (+$4/property)', '1 collaborator', 'Dynamic pricing rules', 'Email sync (OTA order import)'],
      pro: ['5 properties (+$3/property)', '2 collaborators', 'Real-time sync, 60+ channels (prevents overbooking)', 'CS integration (order password lookup)', '1 free setup assist / month'],
      enterprise: ['15 properties (+$2/property)', 'Unlimited collaborators', 'Custom dynamic pricing rules', '2 free setup assists / month'],
    },
    rows: [
  ...
  vi: {
    ...
    cards: {
      ...
      core: ['5 phòng (+$4/phòng)', '1 cộng tác viên', 'Quy tắc định giá động', 'Đồng bộ Email (nhập đơn từ OTA)'],
      pro: ['5 phòng (+$3/phòng)', '2 cộng tác viên', 'Đồng bộ tức thời 60+ kênh (chống overbooking)', 'Tích hợp CS (tra mật khẩu đơn)', '1 lần hỗ trợ cài đặt miễn phí/tháng'],
      enterprise: ['15 phòng (+$2/phòng)', 'Cộng tác viên không giới hạn', 'Quy tắc định giá tùy chỉnh', '2 lần hỗ trợ cài đặt miễn phí/tháng'],
    },
    rows: [
