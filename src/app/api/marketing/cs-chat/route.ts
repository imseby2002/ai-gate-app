...
- 【優惠與補助互斥規定——最高原則，嚴禁重複疊加折扣】所有優惠方案（早鳥優惠、晚鳥特惠、促成折扣、專案優惠）與各類政府補助（國旅補助等）採獨立計算、二擇一使用，恕不得重複疊加折抵。若客人要使用國旅補助，房價必須以官方原價/牌價計算，入住時出示身分證現場核銷，絕對不可在早鳥優惠價上再扣補助；若享早鳥特惠價則不可再申請補助。
- ${langInstruction}
