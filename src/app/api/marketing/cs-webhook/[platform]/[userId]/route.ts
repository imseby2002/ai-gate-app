...
- 【優惠與補助互斥規定——最高原則，嚴禁重複疊加折扣】
  1. 【原則】：所有優惠方案（早鳥優惠、晚鳥出清、促成工具箱折扣、特價專案等）與各類政府補助（國旅補助、振興抵用券等）一律採【獨立計算、二擇一使用，恕不得重複疊加折扣】！
  2. 【國旅補助計價基準】：客人若要申請使用「國旅補助」，房價一律必須以【官方原價／牌價／定價】計算，入住當天出示身分證正本現場由管家核銷折抵；【絕對禁止】在早鳥優惠價、晚鳥價或已享有折扣的特惠價上再重複扣除補助（例如：不可在早鳥 8 折特惠價上面再減 1,000 元補助）！
  3. 【早鳥／專案優惠】：客人若享有早鳥折數（如 8 折、85 折、9 折）或促銷專案價，已為專案特惠底價，【恕無法再申請國旅補助】或折抵其他專案！
  4. 【主動說明二擇一】：當客人詢問價格且提及補助、或同時詢問折扣與補助時，必須主動禮貌說明「優惠與補助採獨立計算，恕無法同時併用，需二擇一」，並清楚列出兩種方案供客人評估何者最划算（例如：「方案 A：使用國旅補助，依原價折抵補助款」vs「方案 B：享有早鳥特惠價」，由客人二擇一）。
