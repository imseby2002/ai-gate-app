  ...
  companyRegulations: [
    {
      id: 'reg-01',
      code: 'REG-FOOD-01',
      title: '【重大食安紅線】過期原料零容忍與標籤偽造懲處規章',
      category: 'food_safety',
      clause_content: '門市原物料一律落實「先進先出 (FIFO)」與標準三聯標籤（品名/製作時間/賞味截止/調配人）。賞味期超過 4 小時之茶湯、超過 4 小時之黑糖珍珠嚴禁回溫加熱或混入新品。任何過期乳品、茶葉或副料必須立即當面拆封倒除報廢。',
      violation_penalty: '私自竄改標籤日期、使用過期原料或隱匿食安瑕疵者，一律記大過處分，情節重大者直接解僱並追究法律責任。',
      manager_enforcement: '店長每日開早、離峰交接、打烊三次親自抽檢冷藏盒標籤時間，每週抽測冷藏冰箱溫控記錄。',
    ...
    },
    {
      id: 'reg-02',
      code: 'REG-FIN-02',
      title: '【誠信收銀與金流零漏洞管理規章】',
      category: 'employee_conduct',
      clause_content: '所有顧客點單必須「先輸入 POS 系統列印交易明細與標籤，方得開始調製飲品」。嚴禁私自收取現金不打單、自備個人第三方支付 QR Code 收款、或將私人現金帶入吧檯收銀機周遭。',
      violation_penalty: '侵占門市營收、私自免單私贈或收銀舞弊者，一律終止勞動契約，追繳全部不當得利並移送司法機關偵辦。',
      manager_enforcement: '店長每兩小時核對一次 POS 系統出單杯數與封口機計數器（杯膜消耗數），杯數誤差超過 3 杯立即停機清查。',
      mandatory_level: 'strict',
      version: '2026.1',
      status: 'active',
    },
    {
      id: 'reg-03',
      code: 'REG-IP-03',
      title: '【營業秘密與產品配方卡保護守則】',
      category: 'confidentiality',
      clause_content: 'Feeling Tea 全品項標準配方卡、果糖檔位比例、基底茶沖泡溫時表、總部供應商進貨成本皆為公司重大核心商業機密。門市夥伴不得私自影印、手機翻拍、抄寫或透過社群轉傳任何配方與手冊資料。',
      violation_penalty: '洩漏公司配方機密予第三方或競爭同業者，依法追究民事高額損害賠償與背信刑責。',
      manager_enforcement: '配方卡一律置於調茶站專屬防水密碼盒內，未經店長授權之訪客或外送員嚴禁進入後吧操作區。',
      mandatory_level: 'strict',
      version: '2026.1',
      status: 'active',
    },
    {
      id: 'reg-04',
      code: 'REG-DISC-04',
      title: '【工作紀律、服裝儀容與私人手機管制規章】',
      category: 'employee_conduct',
      clause_content: '當班同仁必須穿戴標準清洗潔淨之 Feeling Tea 圍裙、工作帽（頭髮全數收納入帽，禁止散落）、深色長褲與防滑包頭工作鞋。吧檯內部一律禁用私人智慧型手機，私人手機於打卡後統一置於休息室員工置物櫃。',
      violation_penalty: '服裝儀容不合規定或在吧檯滑手機者，首次口頭警示，第二次記申誡並扣除當月出勤獎勵。',
      manager_enforcement: '店長於每日班前早會進行 1 分鐘全員儀容檢點（包含手指甲是否剪短、無佩戴戒指手環）。',
      mandatory_level: 'standard',
      version: '2026.1',
      status: 'active',
    },
    {
      id: 'reg-05',
      code: 'REG-SAFE-05',
      title: '【門市工安防護與高溫燙傷預防處置程序】',
      category: 'store_safety',
      clause_content: '熱茶出湯、換桶與加水作業時，必須配戴隔熱防水長袖矽膠手套；吧檯地面積水必須於 30 秒內由紅色專用刮水器清除，並擺放黃色「小心地滑」告示牌。若不幸發生燙傷，嚴禁塗抹牙膏或偏方，立即執行「沖脫泡蓋送」標準急救。',
      violation_penalty: '未配戴防護裝備擅自操作高溫茶桶導致工傷者，追究現場值班幹部監督不周之管理責任。',
      manager_enforcement: '店長每月底點檢門市急救箱之無菌紗布、生理食鹽水與合格燙傷凝膠存量。',
      mandatory_level: 'strict',
      version: '2026.1',
      status: 'active',
    },
    {
      id: 'reg-06',
      code: 'REG-CRISIS-06',
      title: '【重大客訴應對與社群媒體公開言論紅線】',
      category: 'customer_crisis',
      clause_content: '遇顧客任何抱怨，第一線一律遵循「30 秒無條件重新現泡一杯 + 真誠致敬 + 奉新品試飲卡」，嚴禁與顧客當場爭執或辯駁。全體同仁不得以個人社群媒體 (Facebook, Instagram, Threads, TikTok) 發布批評顧客、議論營運紛爭之圖文。',
      violation_penalty: '違反社群紅線損及品牌商譽者，一律送人評會議處；配合總部法務進行危機控管。',
      manager_enforcement: '重大爭議事件（如異物或投訴主管機關）發生後，店長必須於 15 分鐘內透過 AI GATE 通報區督導。',
      mandatory_level: 'strict',
      version: '2026.1',
      status: 'active',
    },
