...
export const SYSTEMS: Record<SystemKey, SystemDef> = {
  ...
  office:    { key: 'office',    label: '公司入口',   desc: '人事、出納總務、研發、門市、外務、稽核、任務等辦公系統', home: '/office', prefixes: ['/office', '/hr', '/personnel', '/finance', '/store-expenses', '/vendors', '/units', '/rd', '/rd-recipes', '/rd-ai', '/rd-logs', '/store-reports', '/store-inventory', '/shift', '/pos', '/affairs', '/audit', '/meeting', '/work', '/roundtable'] },
...
const SHARED_PREFIXES = ['/settings', '/team', '/api', '/callback', '/login', '/register', '/logout', '/privacy', '/work', '/office', '/roundtable']
